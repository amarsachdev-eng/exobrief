...
UK_TARGETS = [
    ...
    {"firm": "Digby Morgan", "contact": "Jon Drape", "title": "Managing Director", "email": "jon.drape@digbymorgan.com", "sector": "hr_consultancy", "hook": "Digby Morgan's specialist HR and interim management recruitment across the UK", "competitors": ["Frazer Jones", "Oakleaf Partnership", "Annapurna HR", "Henlee Resourcing"]},
    ...
    {"firm": "Robert Walters", "contact": "Toby Fowlston", "title": "Group CEO", "email": "toby.fowlston@robertwalters.com", "sector": "recruitment", "hook": "Robert Walters' global recruitment leadership and strong UK professional services presence", "competitors": ["Hays", "Michael Page", "Morgan McKinley", "PageGroup"]},
    {"firm": "Hays UK and Ireland", "contact": "Thomas Way", "title": "CEO", "email": "thomas.way@hays.com", "sector": "recruitment", "hook": "Hays' position as one of the UK's largest specialist recruitment businesses across 21 sectors", "competitors": ["Robert Walters", "Michael Page", "Morgan McKinley", "Reed"]},
    {"firm": "Berry Recruitment", "contact": "Managing Director", "title": "Managing Director", "email": "info@berryrecruitment.co.uk", "sector": "recruitment", "hook": "Berry Recruitment's near £60 million turnover and multi-sector UK presence", "competitors": ["Hays", "Reed", "Adecco", "Manpower"]},
    {"firm": "Morgan McKinley", "contact": "Managing Director", "title": "Managing Director", "email": "info@morganmckinley.com", "sector": "recruitment", "hook": "Morgan McKinley's specialist financial services and professional recruitment across the UK", "competitors": ["Robert Walters", "Hays", "Michael Page", "Reed"]},
    {"firm": "Reed Recruitment", "contact": "James Reed", "title": "Chairman", "email": "james.reed@reedglobal.com", "sector": "recruitment", "hook": "Reed's position as one of the UK's largest family-run recruitment businesses", "competitors": ["Hays", "Robert Walters", "Adecco", "Manpower"]},
    {"firm": "Walker Hamill", "contact": "Managing Partner", "title": "Managing Partner", "email": "info@walkerhamill.com", "sector": "recruitment", "hook": "Walker Hamill's specialist HR and reward executive search across the UK", "competitors": ["Frazer Jones", "Oakleaf Partnership", "Annapurna HR", "Veredus"]},
    {"firm": "Veredus", "contact": "Managing Director", "title": "Managing Director", "email": "info@veredus.co.uk", "sector": "recruitment", "hook": "Veredus's specialist public sector and not-for-profit recruitment across the UK", "competitors": ["Hays", "Reed", "Morgan McKinley", "Robert Walters"]},
    {"firm": "Carrington West", "contact": "Managing Director", "title": "Managing Director", "email": "info@carringtonwest.com", "sector": "recruitment", "hook": "Carrington West's specialist built environment and infrastructure recruitment across the UK", "competitors": ["Hays", "Brandon James", "Penguin Recruitment", "Fusion People"]},
    {"firm": "Brandon James", "contact": "Managing Director", "title": "Managing Director", "email": "info@brandonjames.co.uk", "sector": "recruitment", "hook": "Brandon James' specialist built environment recruitment serving ambitious UK construction firms", "competitors": ["Carrington West", "Penguin Recruitment", "Fusion People", "Hays"]},
    {"firm": "Taylor Root", "contact": "Managing Director", "title": "Managing Director", "email": "info@taylorroot.com", "sector": "recruitment", "hook": "Taylor Root's 35-year legacy as the go-to specialist in legal, risk and compliance recruitment", "competitors": ["BCL Legal", "JMC Legal", "Chadwick Nott", "William James"]},
    {"firm": "BCL Legal", "contact": "Managing Director", "title": "Managing Director", "email": "info@bcllegal.com", "sector": "recruitment", "hook": "BCL Legal's strong Manchester, London and Birmingham legal recruitment presence", "competitors": ["Taylor Root", "JMC Legal", "Chadwick Nott", "William James"]},
    {"firm": "JMC Legal Recruitment", "contact": "Managing Director", "title": "Managing Director", "email": "info@jmc-legal.com", "sector": "recruitment", "hook": "JMC Legal's specialist focus on boutique and Legal 500 firm placements since 2016", "competitors": ["Taylor Root", "BCL Legal", "Chadwick Nott", "William James"]},
    {"firm": "Chadwick Nott", "contact": "Managing Director", "title": "Managing Director", "email": "info@chadwicknott.co.uk", "sector": "recruitment", "hook": "Chadwick Nott's position as the UK's only specialist legal recruiter with national coverage", "competitors": ["Taylor Root", "BCL Legal", "JMC Legal", "William James"]},
    {"firm": "William James Recruitment", "contact": "Managing Director", "title": "Managing Director", "email": "info@williamjamesrecruitment.com", "sector": "recruitment", "hook": "William James' nationwide legal recruitment network spanning Manchester, Leeds, Birmingham and London", "competitors": ["Taylor Root", "BCL Legal", "JMC Legal", "Chadwick Nott"]},
    {"firm": "Michael Page", "contact": "Managing Director", "title": "Managing Director", "email": "info@michaelpage.co.uk", "sector": "recruitment", "hook": "Michael Page's four-decade legacy as one of the UK's leading specialist recruitment brands", "competitors": ["Hays", "Robert Walters", "Reed", "Morgan McKinley"]},
    {"firm": "Robert Half UK", "contact": "Managing Director", "title": "Managing Director", "email": "info@roberthalf.co.uk", "sector": "recruitment", "hook": "Robert Half's specialist finance, technology and legal recruitment across London's finance hubs", "competitors": ["Hays", "Robert Walters", "Michael Page", "Morgan McKinley"]},
    {"firm": "Anthem Consulting", "contact": "Managing Director", "title": "Managing Director", "email": "info@anthemconsulting.com", "sector": "recruitment", "hook": "Anthem Consulting's specialist legal and professional services recruitment across the UK", "competitors": ["Taylor Root", "BCL Legal", "JMC Legal", "Chadwick Nott"]},
    {"firm": "Penguin Recruitment", "contact": "Managing Director", "title": "Managing Director", "email": "info@penguinrecruitment.co.uk", "sector": "recruitment", "hook": "Penguin Recruitment's specialist STEM and built environment recruitment across the UK", "competitors": ["Carrington West", "Brandon James", "Fusion People", "Hays"]},
    {"firm": "Fusion People", "contact": "Managing Director", "title": "Managing Director", "email": "info@fusionpeople.com", "sector": "recruitment", "hook": "Fusion People's specialist infrastructure and rail recruitment serving UK construction projects", "competitors": ["Carrington West", "Brandon James", "Penguin Recruitment", "Hays"]},
]
...
UAE_TARGETS = [
    ...
    {"firm": "BSA Ahmad Bin Hezeem", "contact": "Managing Partner", "title": "Managing Partner", "email": "info@bsabh.com", "sector": "law", "hook": "BSA's position as one of the UAE's leading independent law firms serving regional SMEs", "competitors": ["Al Tamimi", "Hadef & Partners", "Afridi & Angell", "Charterhouse"]},
    {"firm": "Al Tamimi & Company", "contact": "Managing Partner", "title": "Managing Partner", "email": "info@tamimi.com", "sector": "law", "hook": "Al Tamimi's position as the largest law firm in the Middle East serving UAE businesses", "competitors": ["BSA", "Hadef & Partners", "Afridi & Angell", "Clyde & Co"]},
    {"firm": "Hadef & Partners", "contact": "Managing Partner", "title": "Managing Partner", "email": "info@hadefpartners.com", "sector": "law", "hook": "Hadef & Partners' deep UAE legal advisory relationships with local and regional businesses", "competitors": ["Al Tamimi", "BSA", "Afridi & Angell", "Charterhouse"]},
    {"firm": "Crowe Mak UAE", "contact": "Managing Partner", "title": "Managing Partner", "email": "info@crowemak.com", "sector": "accountancy", "hook": "Crowe Mak's specialist UAE accountancy and advisory work with growing businesses", "competitors": ["KGRN", "Kreston Menon", "Farahat & Co", "Morison Menon"]},
    {"firm": "MGI Worldwide UAE", "contact": "Managing Partner", "title": "Managing Partner", "email": "info@mgiworld.com", "sector": "accountancy", "hook": "MGI Worldwide's UAE network supporting growing SME and family businesses", "competitors": ["KGRN", "Kreston Menon", "HLB HAMT", "Morison Menon"]},
    {"firm": "Emirates Chartered Accountants", "contact": "Managing Partner", "title": "Managing Partner", "email": "info@emiratesca.com", "sector": "accountancy", "hook": "Emirates Chartered Accountants' established UAE practice serving local SME clients", "competitors": ["KGRN", "Kreston Menon", "Farahat & Co", "Morison Menon"]},
    {"firm": "ADP UAE Business Setup", "contact": "Managing Director", "title": "Managing Director", "email": "info@adpuae.com", "sector": "business_setup", "hook": "ADP's UAE business setup and advisory services for entrepreneurs and SMEs", "competitors": ["Virtuzone", "Creative Zone", "Commitbiz", "IMC Group"]},
    {"firm": "Shuraa Business Setup", "contact": "Managing Director", "title": "Managing Director", "email": "info@shuraa.com", "sector": "business_setup", "hook": "Shuraa's extensive UAE business setup portfolio supporting thousands of entrepreneurs", "competitors": ["Virtuzone", "Creative Zone", "Commitbiz", "ADP UAE"]},
    {"firm": "Connect Group UAE", "contact": "Managing Director", "title": "Managing Director", "email": "info@connectresources.ae", "sector": "hr_consultancy", "hook": "Connect Group's UAE HR outsourcing and PRO services for growing businesses", "competitors": ["TASC Outsourcing", "Crescent HR", "Ignite HR", "The HR Observer"]},
]
